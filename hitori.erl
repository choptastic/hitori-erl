...
%%big() ->
%%	[9,9,2,2,5,4,12,1,12,7,7,3],
%%	[7,4,2,5,9,2,10,1,3,12,1,8],
%%	[7,8,11,4,4,9,9,7,1,1,5,4],
%%	[6,11,9,5,3,1,8,10,10,2,10,4]


huge() -> [
[12,11,14,13,10,8,20,10,18,6,18,10,3,1,6,15,5,10,9,1]
